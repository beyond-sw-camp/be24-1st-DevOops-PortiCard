  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: "signup-business", name: "signupbusiness", component: () => import("../views/SignupBusiness.vue"),
          meta: { requiresAuth: false, title: "기업 회원가입" } },
        { path: "find-business-account", name: "find-business-account", component: () => import("../views/FindBusinessAccount.vue"),
          meta: { requiresAuth: false, title: "기업 계정 찾기" }},
        { path: "find-personal-account", name: "find-personal-account", component: () => import("../views/FindPersonalAccount.vue"),
          meta: { requiresAuth: false, title: "개인 계정 찾기" }},
        { path: "namecard-search", name:"namecard-search", component: () => import("../views/NameCardSearch.vue"),
          meta: { requiresAuth: false, title: "명함 검색" } },
        { path: "namecard-modify", name:"namecard-modify", component: () => import("../views/NameCardModify.vue"),
          meta: { requiresAuth: false, title: "명함 수정" } },
        { path: "portfolio-project",name: "portfolio-project", component: () => import("../views/PortfolioProject.vue"),
          meta: { requiresAuth: true, title: "포트폴리오 작성" } },
        { path: "portfolio-update-n-check",name:"portfolio-update-n-check", component: () => import("../views/PortfolioUpdateAndCheck.vue") },
        { path: "portfolio-style", name:"portfolio-style",component: () => import("../views/PortfolioStyle.vue") },
        { path: "portfolio-view", name: "portfolio-view", component: () => import("../views/PortfolioView.vue"),
        ...
        { path: "community-write", name: "community-write", component: () => import("../views/CommunityWrite.vue"),
    ...
    },
    {
      ...
      children: [
        { path: "", component: () => import("../views/VideoChat.vue") },
      ]
    },
  ],
})
...
if (to.name === 'login' || to.name === 'signup' || to.name === 'signup-business' || to.name === 'find-business-account' || to.name === 'find-personal-account') {
    return next()
}
